...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const QUESTIONS = [
    {
      id: 1,
      optA: { text: "진심 어린 격려의 말은 큰 힘이 된다.", type: '격려형' },
      optB: { text: "함께해 준 시간이 큰 힘이 된다.", type: '동행형' }
    },
    {
      id: 2,
      optA: { text: "나를 생각해서 실제로 도와주는 행동이 고맙다.", type: '실천형' },
      optB: { text: "나를 생각해서 준비한 작은 선물과 손편지가 고맙다.", type: '마음형' }
    },
    {
      id: 3,
      optA: { text: "반갑게 악수하거나 포옹하며 인사를 건네주면 가까워진 느낌이 든다.", type: '친밀형' },
      optB: { text: "진심 어린 안부를 묻고 따뜻하게 인사를 건네주면 가까워진 느낌이 든다.", type: '격려형' }
    },
    {
      id: 4,
      optA: { text: "함께 식사하거나 산책하며 시간을 보내면 마음이 편안해지고 힘을 얻는다.", type: '동행형' },
      optB: { text: "내가 어려움을 겪을 때 말없이 필요한 일을 도와주면 마음이 편안해지고 힘을 얻는다.", type: '실천형' }
    },
    {
      id: 5,
      optA: { text: "힘든날, 나를 생각하며 준비한 작은 선물이나 손편지를 받으면 위로가 된다.", type: '마음형' },
      optB: { text: "힘든날, 따뜻하게 안아주거나 등을 토닥여 주면 위로가 된다.", type: '친밀형' }
    },
    {
      id: 6,
      optA: { text: "힘들 때 진심 어린 격려와 응원의 말을 들으면 다시 도전할 용기가 생긴다.", type: '격려형' },
      optB: { text: "힘든 일을 혼자 감당하지 않도록 곁에서 함께해 주면 다시 힘을 낼 수 있다.", type: '실천형' }
    },
    {
      id: 7,
      optA: { text: "바쁜 중에도 나를 위해 시간을 내어 함께해 주는 것이 가장 감동적이다.", type: '동행형' },
      optB: { text: "바쁜 중에도 나를 생각하며 정성껏 준비한 작은 선물이나 메모가 가장 감동적이다.", type: '마음형' }
    },
    {
      id: 8,
      optA: { text: "밝게 웃어주고 함께 기뻐하며 즐거운 순간을 나누는 것이 좋다.", type: '친밀형' },
      optB: { text: "함께 커피를 마시며 편안하게 이야기를 나누는 시간이 좋다.", type: '동행형' }
    },
    {
      id: 9,
      optA: { text: "내가 필요로 하는 것을 알아차리고 행동으로 도와주는 배려가 더 큰 힘이 된다.", type: '실천형' },
      optB: { text: "내 노력을 알아주고 칭찬과 격려의 말을 해주는 것이 더 큰 힘이 된다.", type: '격려형' }
    },
    {
      id: 10,
      optA: { text: "나를 기억하며 준비한 작은 선물이나 간식에서 따뜻한 마음이 느껴진다.", type: '마음형' },
      optB: { text: "나를 반갑게 맞아주며 눈을 맞추고 환하게 미소 지어줄 때 따뜻한 마음이 느껴진다.", type: '친밀형' }
    },
    {
      id: 11,
      optA: { text: "내 이야기를 서두르지 않고 끝까지 들어주는 사람이 좋다.", type: '동행형' },
      optB: { text: '“잘했어요”, “괜찮아요”처럼 힘이 되는 말을 건네주는 사람이 좋다.', type: '격려형' }
    },
    {
      id: 12,
      optA: { text: "내가 부탁하기 전에 필요한 일을 먼저 알아서 도와주면 기쁘다.", type: '실천형' },
      optB: { text: "특별한 날이 아니어도 나를 생각하며 작은 선물을 준비해 주면 기쁘다.", type: '마음형' }
    },
    {
      id: 13,
      optA: { text: "따뜻한 눈맞춤과 미소, 자연스러운 손길을 받으면 위로가 된다.", type: '친밀형' },
      optB: { text: "함께 있어주고 이야기를 나누면 위로가 된다.", type: '동행형' }
    },
    {
      id: 14,
      optA: { text: "힘들 때 진심 어린 격려와 응원의 말을 들으면 다시 힘이 난다.", type: '격려형' },
      optB: { text: "힘들 때 필요한 일을 직접 도와주는 행동을 받으면 다시 힘이 난다.", type: '실천형' }
    },
    {
      id: 15,
      optA: { text: "누군가 나를 생각하며 정성껏 준비한 선물이나 간식이 오래 기억에 남는다.", type: '마음형' },
      optB: { text: "환하게 웃으며 반갑게 맞아주고 따뜻하게 인사해준 순간이 오래 기억에 남는다.", type: '친밀형' }
    },
    {
      id: 16,
      optA: { text: "바쁜데도 시간을 내어 함께해 줄 때 사랑받고 있다고 느낀다.", type: '동행형' },
      optB: { text: "나의 노력이나 장점을 알아보고 인정과 칭찬을 해줄 때 사랑받고 있다고 느낀다.", type: '격려형' }
    },
    {
      id: 17,
      optA: { text: "내가 어려움을 겪을 때 실제로 도움을 받으면 마음이 열린다.", type: '실천형' },
      optB: { text: "나를 생각하며 준비한 작은 선물이나 정성을 받으면 마음이 열린다.", type: '마음형' }
    },
    {
      id: 18,
      optA: { text: "악수나 하이파이브처럼 자연스럽게 손을 맞잡거나 스킨십을 나누는 것이 좋다.", type: '친밀형' },
      optB: { text: "내 이야기를 들어주거나 필요한 시간을 함께 보내주는 것이 좋다.", type: '동행형' }
    },
    {
      id: 19,
      optA: { text: "힘들 때 진심 어린 격려와 응원의 말을 건네주는 사람이 좋다.", type: '격려형' },
      optB: { text: "말보다 행동으로 작은 배려를 직접 보여주는 사람이 좋다.", type: '실천형' }
    },
    {
      id: 20,
      optA: { text: "예상하지 못한 순간에 나를 생각해 준비한 작은 선물을 받으면 기쁘다.", type: '마음형' },
      optB: { text: "따뜻하게 안아주거나 반갑게 맞아주는 순간이 있으면 기쁘다.", type: '친밀형' }
    },
    {
      id: 21,
      optA: { text: "서로의 생각과 마음을 깊이 나누며 오랫동안 이야기하는 시간이 좋다.", type: '동행형' },
      optB: { text: "내가 잘한 일을 알아주고 감사와 칭찬의 말을 자주 해주는 것이 좋다.", type: '격려형' }
    },
    {
      id: 22,
      optA: { text: "힘든 일이 있을 때 내 몫까지 함께 나누고 직접 도와주는 사람이 좋다.", type: '실천형' },
      optB: { text: "손편지처럼 시간을 들여 마음을 담아 표현해주는 사람이 좋다.", type: '마음형' }
    },
    {
      id: 23,
      optA: { text: "환하게 웃으며 하이파이브를 하거나 손을 잡아주면 힘이 난다.", type: '친밀형' },
      optB: { text: "누군가 나를 위해 시간을 내주는 것에 힘이 난다.", type: '동행형' }
    },
    {
      id: 24,
      optA: { text: "내 노력이나 성과를 알아보고 인정과 칭찬을 해준 사람이 더 기억에 남는다.", type: '격려형' },
      optB: { text: "내가 어려울 때 먼저 다가와 직접 도와준 사람이 더 기억에 남는다.", type: '실천형' }
    },
    {
      id: 25,
      optA: { text: "여행이나 특별한 순간을 떠올리게 하는 작은 기념품도 오래 간직한다.", type: '마음형' },
      optB: { text: "힘들 때 따뜻하게 등을 토닥여주거나 안아준 위로가 오래 기억에 남는다.", type: '친밀형' }
    },
    {
      id: 26,
    ...
    {
      id: 27,
      optA: { text: "나를 위해 직접 행동으로 보여준 배려가 가장 기억에 남는다.", type: '실천형' },
      optB: { text: "나를 생각하며 정성껏 준비한 작은 선물이나 정성이 가장 기억에 남는다.", type: '마음형' }
    },
    {
      id: 28,
      optA: { text: "자연스럽게 손을 잡아주거나 가볍게 어깨를 토닥여주는 사람이 친근하게 느껴진다.", type: '친밀형' },
    ...
    },
    {
      ...
      optB: { text: "따뜻하게 안아주거나 등을 토닥여주는 위로에서 큰 위안을 받는다.", type: '친밀형' }
    }
  ];
