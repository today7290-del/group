...
const QUESTIONS = [
  ...
  },
  {
    ...
    optB: { text: "나를 생각하며 준비한 작은 간식이나 선물을 받으면 위로가 된다.", type: '마음형' }
  },
  {
    id: 7,
  ...
  },
  {
    ...
    optB: { text: "나를 생각하며 정성껏 준비한 작은 것을 받으면 마음이 열린다.", type: '마음형' }
  },
  {
    id: 10,
  ...
  {
    id: 11,
    optA: { text: "나를 생각해서 준비한 손편지나 작은 선물이 오래 기억에 남는다.", type: '마음형' },
  ...
  },
  {
    ...
    optB: { text: "나를 생각하며 작은 선물이나 메모를 준비해 주면 든든하다.", type: '마음형' }
  },
  {
    id: 18,
  ...
  },
  {
    ...
    optB: { text: "나를 생각하며 준비한 작은 선물이나 간식을 받으면 기분이 좋아진다.", type: '마음형' }
  },
  {
    id: 21,
  ...
  {
    id: 25,
    optA: { text: "나를 생각하며 준비한 작은 기념품이나 정성스러운 선물이 오래 기억에 남는다.", type: '마음형' },
  ...
  {
    id: 30,
    optA: { text: "나를 위해 준비한 작은 간식이나 물건에서 나를 생각해 준 마음이 느껴진다.", type: '마음형' },
