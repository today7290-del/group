...
const questions = [
  {
    id: 1,
    optA: { text: "진심 어린 격려의 말을 들으면 내가 소중한 사람이라는 느낌이 든다.", type: '격려형' },
    optB: { text: "바쁜 중에도 나를 위해 시간을 내어 함께해 주면 내가 소중한 사람이라는 느낌이 든다.", type: '동행형' }
  },
  {
    id: 2,
    optA: { text: "내가 어려울 때 필요한 일을 실제로 도와주면 깊은 고마움을 느낀다.", type: '실천형' },
    optB: { text: "나를 생각하며 준비한 작은 선물이나 메모를 받으면 깊은 고마움을 느낀다.", type: '마음형' }
  },
  {
    id: 3,
    optA: { text: "반갑게 웃으며 눈을 맞추고 따뜻하게 맞아주면 가까워진 느낌이 든다.", type: '친밀형' },
    optB: { text: "내 이야기에 관심을 보이며 따뜻한 말로 안부를 물어주면 가까워진 느낌이 든다.", type: '격려형' }
  },
  {
    id: 4,
    optA: { text: "함께 식사하거나 산책하며 편안하게 이야기를 나누는 시간이 큰 힘이 된다.", type: '동행형' },
    optB: { text: "내가 힘들어할 때 필요한 일을 알아차리고 실제로 도와주는 것이 큰 힘이 된다.", type: '실천형' }
  },
  {
    id: 5,
    optA: { text: "힘든 날, 나를 생각하며 준비한 작은 간식이나 선물을 받으면 위로가 된다.", type: '마음형' },
    optB: { text: "힘든 날, 따뜻한 표정과 반응으로 곁에서 위로해 주면 마음이 놓인다.", type: '친밀형' }
  },
  {
    id: 6,
    optA: { text: "힘들 때 진심 어린 응원과 격려를 들으면 다시 도전할 용기가 생긴다.", type: '격려형' },
    optB: { text: "힘든 일을 혼자 감당하지 않도록 곁에서 함께 시간을 보내주면 다시 힘을 낼 수 있다.", type: '동행형' }
  },
  {
    id: 7,
    optA: { text: "말없이 필요한 일을 먼저 도와주는 행동에서 사랑을 느낀다.", type: '실천형' },
    optB: { text: "특별한 날이 아니어도 나를 생각하며 준비한 작은 정성에서 사랑을 느낀다.", type: '마음형' }
  },
  {
    id: 8,
    optA: { text: "환하게 웃으며 반갑게 맞아주고 함께 기뻐해 주면 마음이 따뜻해진다.", type: '친밀형' },
    optB: { text: "함께 커피를 마시며 서두르지 않고 이야기를 나누는 시간이 마음을 따뜻하게 한다.", type: '동행형' }
  },
  {
    id: 9,
    optA: { text: "내 노력을 알아주고 구체적으로 칭찬해 주면 큰 힘이 된다.", type: '격려형' },
    optB: { text: "내가 필요로 하는 것을 알아차리고 실제적인 도움을 주면 큰 힘이 된다.", type: '실천형' }
  },
  {
    id: 10,
    optA: { text: "내가 좋아할 만한 작은 것을 기억하고 준비해 주면 따뜻한 마음이 느껴진다.", type: '마음형' },
    optB: { text: "나를 반갑게 맞아주고 눈을 맞추며 환하게 웃어주면 따뜻한 마음이 느껴진다.", type: '친밀형' }
  },
  {
    id: 11,
    optA: { text: "내 이야기를 서두르지 않고 끝까지 들어주는 사람이 곁에 있으면 마음이 편안하다.", type: '동행형' },
    optB: { text: "“잘하고 있어요”, “괜찮아요”처럼 힘이 되는 말을 건네주면 마음이 편안하다.", type: '격려형' }
  },
  {
    id: 12,
    optA: { text: "내가 부탁하기 전에 필요한 일을 먼저 알아서 도와주면 사랑받는 느낌이 든다.", type: '실천형' },
    optB: { text: "나와 관련된 작은 일이나 중요한 순간을 기억해 주면 사랑받는 느낌이 든다.", type: '마음형' }
  },
  {
    id: 13,
    optA: { text: "따뜻한 눈맞춤과 미소, 자연스러운 반응을 받으면 위로가 된다.", type: '친밀형' },
    optB: { text: "힘든 이야기를 나눌 때 서두르지 않고 함께 있어주면 위로가 된다.", type: '동행형' }
  },
  {
    id: 14,
    optA: { text: "나의 장점이나 노력을 알아보고 인정해 주는 말을 들으면 마음이 열린다.", type: '격려형' },
    optB: { text: "내가 어려울 때 직접 시간을 내어 필요한 일을 도와주면 마음이 열린다.", type: '실천형' }
  },
  {
    id: 15,
    optA: { text: "누군가 나를 생각하며 정성껏 준비한 작은 선물이 오래 기억에 남는다.", type: '마음형' },
    optB: { text: "힘들 때 따뜻하게 반응해 주고 곁에서 함께해 준 순간이 오래 기억에 남는다.", type: '친밀형' }
  },
  {
    id: 16,
    optA: { text: "바쁜데도 시간을 내어 나와 식사하거나 산책해 줄 때 사랑받고 있다고 느낀다.", type: '동행형' },
    optB: { text: "나의 수고를 알아보고 구체적인 말로 인정해 줄 때 사랑받고 있다고 느낀다.", type: '격려형' }
  },
  {
    id: 17,
    optA: { text: "내가 어려움을 겪을 때 실제적인 도움을 받으면 마음이 든든해진다.", type: '실천형' },
    optB: { text: "나를 생각해서 준비한 작은 간식이나 손편지를 받으면 마음이 든든해진다.", type: '마음형' }
  },
  {
    id: 18,
    optA: { text: "악수나 하이파이브처럼 서로 편안하게 받아들일 수 있는 따뜻한 표현이 좋다.", type: '친밀형' },
    optB: { text: "내 이야기를 들어주고 필요한 시간을 함께 보내주는 것이 좋다.", type: '동행형' }
  },
  {
    id: 19,
    optA: { text: "힘들 때 진심이 담긴 응원과 격려의 말을 들으면 다시 힘을 낼 수 있다.", type: '격려형' },
    optB: { text: "말보다 행동으로 필요한 도움을 직접 보여주면 다시 힘을 낼 수 있다.", type: '실천형' }
  },
  {
    id: 20,
    optA: { text: "예상하지 못한 순간에 나를 생각해서 준비한 작은 것을 받으면 기쁘다.", type: '마음형' },
    optB: { text: "반갑게 맞아주고 환하게 웃어주며 따뜻하게 반응해 주면 기쁘다.", type: '친밀형' }
  },
  {
    id: 21,
    optA: { text: "서로의 생각과 마음을 깊이 나누며 충분한 시간을 보내는 것이 좋다.", type: '동행형' },
    optB: { text: "내가 잘한 일을 알아주고 감사와 칭찬의 말을 해주는 것이 좋다.", type: '격려형' }
  },
  {
    id: 22,
    optA: { text: "힘든 일이 있을 때 내 몫까지 함께 나누고 직접 도와주는 사람이 좋다.", type: '실천형' },
    optB: { text: "손편지나 메모처럼 시간을 들여 마음을 담아 표현해 주는 사람이 좋다.", type: '마음형' }
  },
  {
    id: 23,
    optA: { text: "환하게 웃으며 반갑게 반응해 주고 함께 기뻐해 주면 힘이 난다.", type: '친밀형' },
    optB: { text: "누군가 나를 위해 시간을 내어 천천히 이야기를 들어주면 힘이 난다.", type: '동행형' }
  },
  {
    id: 24,
    optA: { text: "내 노력이나 성과를 알아보고 인정과 칭찬을 해준 사람이 더 기억에 남는다.", type: '격려형' },
    optB: { text: "내가 어려울 때 먼저 다가와 실제적인 도움을 준 사람이 더 기억에 남는다.", type: '실천형' }
  },
  {
    id: 25,
    optA: { text: "여행이나 특별한 순간을 떠올리게 하는 작은 기념품이나 사진을 오래 간직한다.", type: '마음형' },
    optB: { text: "힘들 때 따뜻한 표정과 반응으로 위로해 준 순간이 오래 기억에 남는다.", type: '친밀형' }
  },
  {
    id: 26,
    optA: { text: "함께 식사하며 이야기를 나누는 시간이 서로의 관계를 더 깊게 만든다고 느낀다.", type: '동행형' },
    optB: { text: "진심 어린 격려와 응원의 말이 서로의 관계를 더 깊게 만든다고 느낀다.", type: '격려형' }
  },
  {
    id: 27,
    optA: { text: "나를 위해 직접 행동으로 보여준 배려가 가장 오래 기억에 남는다.", type: '실천형' },
    optB: { text: "나를 생각하며 시간과 정성을 들여 준비한 것이 가장 오래 기억에 남는다.", type: '마음형' }
  },
  {
    id: 28,
    optA: { text: "자연스럽게 손을 맞잡거나 가볍게 어깨를 토닥이는 등 편안한 표현이 친근하게 느껴진다.", type: '친밀형' },
    optB: { text: "함께 산책하거나 차를 마시며 편안하게 이야기를 나누는 사람이 친근하게 느껴진다.", type: '동행형' }
  },
  {
    id: 29,
    optA: { text: "힘들 때 진심 어린 응원과 격려의 말을 들으면 다시 힘을 낼 수 있다.", type: '격려형' },
    optB: { text: "힘들 때 말없이 곁에서 필요한 일을 도와주면 다시 힘을 낼 수 있다.", type: '실천형' }
  },
  {
    id: 30,
    optA: { text: "내가 좋아할 만한 간식이나 작은 물건을 챙겨주는 정성에서 위로를 받는다.", type: '마음형' },
    optB: { text: "따뜻한 미소와 눈빛, 편안한 반응으로 위로해 주는 데서 큰 위안을 받는다.", type: '친밀형' }
  }
];
